...
namespace SB_Item_Creator
{
    class Value
    {
        public static string itemname="Default",itemfilename="Default",itemlevel,description;
        ...
        public static string projtype = "bullet-1",speed;
        public static bool recoil = false, level = false;
        public static string pathsave = GetAppDataPath();
        public static bool dirready = false;
        public static string blueprinttier = "tier1";
        public static string craftingstation, item1 = "none", item2 = "none", item3 = "none", item4 = "none", item5 = "none", item6 = "none";
